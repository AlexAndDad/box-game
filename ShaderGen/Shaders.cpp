...
Shaders::Shaders(std::string const& vertexPath, std::string const & fragmentPath)
{
    changeTexture(vertexPath,fragmentPath);
}

void Shaders::changeTexture(std::string const &vertexPath, std::string const &fragmentPath)
{
